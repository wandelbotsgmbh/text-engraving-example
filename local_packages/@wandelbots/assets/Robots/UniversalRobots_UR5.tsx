...
import model from "./models/UniversalRobots_UR5.glb"

export function UniversalRobots_UR5({ axisConfig, ...props }: RobotProps) {
    ...
    <group {...props} dispose={null}>
      <group name="Scene">
        <group name="UR5" rotation={[Math.PI / 2, 0, 0]}>
          <group name="UR5_J01" rotation={[-Math.PI / 2, 0, 0]} ref={axis_1}>
            <group
              name="UR5_J02"
              position={[0, 0.089, 0]}
              ...
              ref={axis_2}
            >
              <group name="UR5_J03" position={[-0.425, 0, 0]} ref={axis_3}>
                <group name="UR5_J04" position={[-0.392, 0, 0]} ref={axis_4}>
                  <group
                    name="UR5_J05"
                    position={[0, 0.109, 0]}
                    rotation={[Math.PI / 2, 0, 0]}
