...
import model from "./models/UniversalRobots_UR3e.glb"

export function UniversalRobots_UR3e({ axisConfig, ...props }: RobotProps) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene">
        <group name="UR3e" rotation={[Math.PI / 2, 0, 0]}>
          <group name="UR3e_J01" rotation={[-Math.PI / 2, 0, 0]} ref={axis_1}>
            <group
              name="UR3e_J02"
              position={[0, 0.152, 0]}
              ...
              ref={axis_2}
            >
              <group name="UR3e_J03" position={[-0.244, 0, 0]} ref={axis_3}>
                <group name="UR3e_J04" position={[-0.213, 0, 0]} ref={axis_4}>
                  <group
                    name="UR3e_J05"
                    position={[0, 0.131, 0]}
                    rotation={[Math.PI / 2, 0, 0]}
