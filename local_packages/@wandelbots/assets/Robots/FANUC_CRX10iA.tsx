...
import model from "./models/FANUC_CRX10iA.glb"

export function FANUC_CRX10iA({ axisConfig, ...props }: RobotProps) {
      ...
      <group name="Scene">
        <group name="CRX10iA_J00" ref={axis_1}>
          <group
            ...
            ref={axis_2}
          >
            <group name="CRX10iA_J02" position={[0.54, 0, 0]} ref={axis_3}>
              <group
                name="CRX10iA_J03"
